...
The result is a site that loads in under two seconds on mobile, ranks well in Google, and is genuinely editable by the client without anyone having to call me to change a phone number. It's the approach I take on [most builds now](/web-design/).
