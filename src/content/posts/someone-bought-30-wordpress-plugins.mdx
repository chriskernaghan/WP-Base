...
image: "/blog/security-breach.webp"
---
...
WordPress itself pushed a forced update to neutralise the phone-home mechanism in the affected plugins. But that update didn't clean up the damage already done. Make sure your WordPress core, all plugins, and your theme are fully up to date. If nobody is [doing that on a schedule](/wordpress-maintenance/), this is the argument for starting.
