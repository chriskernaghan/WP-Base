...
date: 2026-03-13
readTime: "6 min read"
image: "/blog/sidehustle-image.jpg"
---
...
Whatever you build, make sure it [loads quickly](/website-speed/), looks right on a phone, and has a proper SSL certificate (that padlock in the browser bar). These aren't nice-to-haves, they're basics that anyone visiting your site will notice if they're missing, even if they can't quite name what's wrong.

If you've got a site already and you're not sure whether it's doing its job, have a look at it on your phone with fresh eyes. Would you trust this business? Would you get in touch? If the honest answer is no, that's worth sorting, and [these are the signs worth checking first](/posts/7-signs-your-small-business-website-needs-a-redesign/).
