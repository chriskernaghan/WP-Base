...
If you want the longer version of how to judge a host, including whether the server being in Northern Ireland actually matters, that's covered in [where to host your website](/posts/where-to-host-your-website-northern-ireland/).
...
This is why [any hosting I set up stays in the client's own account](/hosting/). You should own your hosting account directly. You should know your login credentials. You should be able to fire your developer tomorrow and still have full access to your own site. If that's not currently the case, sort it now while everyone's still on speaking terms.
